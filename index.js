...
login_form.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        postData(`http://192.168.1.64:5000/login`).then((data) => {
            if (data.res == 'ok') {
...
function get_all_messages() {
    ...
    get_previous_chats(`http://192.168.1.64:5000/msj`).then((res) => {
...
function start_tracking_messages() {
    ...
    get_updated_messages(`http://192.168.1.64:5000/current`).then((res) => {
...
send_new_message.addEventListener('submit', (event) => {
    ...
    postData(`http://192.168.1.64:5000/add_msj`).then((data) => { })
    message.value = ''
...
function delete_all_current_messages() {
    fetch('http://192.168.1.64:5000/delete', {
        method: 'DELETE',
    })
        .then(res => res.json())
